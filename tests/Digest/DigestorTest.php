...
class DigestorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testtimerStart(): void
    {
        ...
        $this->assertIsCallable([$this->object, 'timerStart']);
    ...
    public function testtimerStop(): void
    {
        ...
        $this->assertIsCallable([$this->object, 'timerStop']);
     ...
     */
    public function testtimerValue(): void
    {
        ...
        $this->assertIsCallable([$this->object, 'timerValue']);
