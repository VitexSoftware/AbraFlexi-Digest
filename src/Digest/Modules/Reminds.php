    ...
    public function dig(): bool
    {
        ...
        if (empty($faDatakturyRaw)) {
            ...
            foreach ($faDatakturyRaw as $invoice => $invoiceData) {
                ...
                $invoicer->setMyKey(\AbraFlexi\Code::ensure((string) $invoiceData['kod']));
                $nazevFirmy = \AbraFlexi\Code::strip((string) (string) $invoiceData['firma']);
                $invTable->addRowColumns([
                    ...
                    ' '.\AbraFlexi\Code::strip((string) (string) $invoiceData['mena']),
